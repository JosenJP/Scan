...
bool FilterBuild::IsGoodFile(const char* a_pFileName, FileType& a_FileType /* output */)
{
    ...
    if (ExtensionHelper::CheckExtension(a_pFileName, EXTENSION_CPP))
    {
        a_FileType = FileType::CPP;
    }
    else if (ExtensionHelper::CheckExtension(a_pFileName, EXTENSION_H))
    {
        a_FileType = FileType::H;
    }
    else if (ExtensionHelper::CheckExtension(a_pFileName, EXTENSION_HPP))
    {
        a_FileType = FileType::HPP;
    }
    else if (ExtensionHelper::CheckExtension(a_pFileName, EXTENSION_HR))
    {
        a_FileType = FileType::HR;
    }
    else if (ExtensionHelper::CheckExtension(a_pFileName, EXTENSION_PROJ))
    {
        a_FileType = FileType::PROJ;
    }
    else if (ExtensionHelper::CheckExtension(a_pFileName, EXTENSION_C))
    {
        a_FileType = FileType::C;
    }
    else if (ExtensionHelper::CheckExtension(a_pFileName, EXTENSION_RC))
    {
        a_FileType = FileType::RC;
    }
    else
    {
